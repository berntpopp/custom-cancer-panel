...
script_path <- "/analyses/G03_DiagnosticPanels/"
...
write_csv(all_diagnostic_panels_genes_format,
  file = paste0("results/G03_DiagnosticPanels_genes.",
    creation_date,
    ".csv"),
  na = "NULL")
...
gzip(paste0("results/G03_DiagnosticPanels_list.", creation_date, ".csv"),
  overwrite = TRUE)
############################################
